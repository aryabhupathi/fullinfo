...
const AssignStudent = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    const response = await fetch("http://localhost:1111/admission/assigntransport", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        studentName: formData.studentName,
        vehicleNumber: "V123", // get this from props or context
      }),
    });
    ...
    if (data.status === "PASS") {
      setMessage("Student assigned to transport successfully!");
    } else {
...
//         body: JSON.stringify({
//           studentName: formData.studentName,
//           vehicleNumber: transport.vehicleNumber, // ✅ Use dynamic vehicle number
//         }),
//       });
